...
Lisäksi voidaan osoittaa~\parencite[Luku 3.2]{laarhoven} että kun Markov-ketjujen pituus kullakin $t$ on yksi  tai yleisemmin äärellinen (epähomogeeni algoritmi),
